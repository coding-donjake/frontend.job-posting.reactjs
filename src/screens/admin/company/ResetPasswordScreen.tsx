...
const ResetPasswordScreen = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success("Company password has been reset.");
        navigate(-1);
        return;
      }
      toast.error("Unkown error occured!");
  ...
  useEffect(() => {
    document.title = "Reset Company Password";
  }, []);
                  ...
                  formGroups={[
                    {
                      items: [
                        <PrimarySticker
                          ...
                          text={`Are you sure you want to reset ${company.User.username}'s password?`}
                        />,
                      ],
                    },
                    {
